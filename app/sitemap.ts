...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/pg`, changeFrequency: 'daily', priority: 0.9 },
    { url: `${SITE_URL}/flats`, changeFrequency: 'daily', priority: 0.9 },
    { url: `${SITE_URL}/villas`, changeFrequency: 'daily', priority: 0.9 },
    { url: `${SITE_URL}/commercial`, changeFrequency: 'daily', priority: 0.85 },
    { url: `${SITE_URL}/plots`, changeFrequency: 'daily', priority: 0.85 },
